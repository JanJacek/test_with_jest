...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"nasaApi.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.nasaMsg = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.get("https://api.nasa.gov/planetary/apod?api_key=aRmGij9Qh1oahMdOAYjkeqrAGaiyVoryOztfE1ez").then(function (res) {
              return res;
            }).catch(function (err) {
          ...
          case 2:
            ...
            return _context.abrupt("return", getResponse);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _nasaApi.nasaMsg)().then(function (res) {
              fromNasa = res.data;
            });

          case 2:
            console.log(fromNasa);
            document.getElementById("bg").style.backgroundImage = "url(\"".concat(fromNasa.url, "\")");
...
getData();
},{"./nasaApi":"nasaApi.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
